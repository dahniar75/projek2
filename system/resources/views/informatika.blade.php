	...
	<div class="row mt-5 no-gutters">
		<div class="col-md-2 bg-light">
			<ul class="list-group list-group-flush p-2 pt-4">
			  <li class="list-group-item bg-danger text-warning"><i class="fas fa-list"></i> KATEGORI PRODUK </li>
			  <li class="list-group-item"><i class="fas fa-angle-right"></i> Variasi Warna </li>
			  <li class="list-group-item"><i class="fas fa-angle-right"></i> Dekorasi Acara</li>
			  <li class="list-group-item"><i class="fas fa-angle-right"></i> Hiasan Rumah</li>
			  <li class="list-group-item"><i class="fas fa-angle-right"></i> Hadiah Spesial</li>
			</ul>
		</div>
		<div class="col-md-10">
